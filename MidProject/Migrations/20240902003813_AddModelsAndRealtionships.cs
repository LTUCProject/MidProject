...
{
    /// <inheritdoc />
    public partial class AddModelsAndRealtionships : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_MaintenanceLogs_Admins_AdminId",
                        column: x => x.AdminId,
                        principalTable: "Admins",
                        principalColumn: "AdminId");
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ProviderId1 = table.Column<int>(type: "int", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_ServiceInfos_Providers_ProviderId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_AspNetUsers_ProviderId1",
                table: "AspNetUsers",
                column: "ProviderId1");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_MaintenanceLogs_AdminId",
            ...
            migrationBuilder.AddForeignKey(
                name: "FK_AspNetUsers_Providers_ProviderId1",
                table: "AspNetUsers",
                column: "ProviderId1",
                principalTable: "Providers",
                principalColumn: "ProviderId",
