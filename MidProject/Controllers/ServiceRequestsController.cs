...
namespace MidProject.Controllers
{
    ...
    public class ServiceRequestsController : ControllerBase
    {
        ...
        public ServiceRequestsController(MidprojectDbContext context)
        {
            _context = context;
        }
        ...
        public async Task<ActionResult<ServiceRequest>> PostServiceRequest(ServiceRequest serviceRequest)
        {
          if (_context.ServiceRequests == null)
          {
              return Problem("Entity set 'MidprojectDbContext.ServiceRequests'  is null.");
          }
        ...
        {
            return (_context.ServiceRequests?.Any(e => e.ServiceRequestId == id)).GetValueOrDefault();
        }
    }
}
